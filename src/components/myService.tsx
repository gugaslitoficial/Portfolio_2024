    ...
    return (
        ...
        style={{ backgroundImage: "url('bg-3.jpg')" }}>
            ...
            <div className="h-full w-full flex justify-start text-end items-end">
                <div className="h-full sm:w-6/12 md:w-6/12 lg:w-3/6 xl:w-1/2 2xl:w-1/2 flex flex-col ">
                    <h1 className="text-slate-950 sm:text-sm md:text-base lg:text-xl xl:text-3xl 2xl:text-4xl sm:pt-3 sm:pb-1 md:pt-5 md:pb-3 py-5 font-bold">
                        WEB DEVELOPMENT</h1>
                        <p 
                        className="text-white sm:text-sm md:text-sm lg:text-base xl:text-xl 2xl:text-2xl font-semibold ">
                    ...
                    <h1 
                    className="text-slate-950 sm:text-sm md:text-base lg:text-xl xl:text-3xl 2xl:text-4xl sm:py-2 md:py-3 lg:py-3 xl:py-5 font-bold ">
