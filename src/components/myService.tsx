...
export default function Service() {
    ...
    return (
        ...
        <div className="h-screen w-full p-8 sm:p-4 md:p-8 lg:p-10 xl:p-16 2xl:p-20 bg-cover bg-center bg-no-repeat flex flex-col items-end gap-10 sm:gap-2 md:gap-2 lg:gap-0 xl:gap-8 2xl:gap-10 py-20" 
            ...
            <div className="w-full flex justify-start text-start sm:text-end sm:items-end">
                <div className="w-full sm:w-6/12 md:w-6/12 lg:w-3/6 xl:w-1/2 2xl:w-1/2 flex flex-col">
                    <h1 className="text-slate-950 text-xl sm:text-sm md:text-base lg:text-base xl:text-xl 2xl:text-4xl pt-0 pb-3 sm:pt-3 sm:pb-1 md:pt-1 md:pb-2 lg:pt-5 xl:py-0 font-bold">
                        WEB DEVELOPMENT</h1>
                        <p 
                        className="text-slate-50 sm:text-white text-lg sm:text-sm md:text-sm lg:text-sm xl:text-lg 2xl:text-2xl font-bold sm:font-semibold ">
