...
export default function Service() {
    ...
    return (
        ...
        <div id="service" className="h-screen w-full p-3 sm:p-4 md:p-8 lg:p-10 xl:p-16 2xl:p-20 bg-cover bg-center bg-no-repeat flex flex-col items-end gap-16 sm:gap-2 md:gap-2 lg:gap-0 xl:gap-8 2xl:gap-10 py-20" 
        style={{ backgroundImage: "url('bg-3.jpg')" }}>
            ...
            <div className="w-full flex justify-start text-start sm:text-end sm:items-end">
                <div className="w-full sm:w-6/12 md:w-6/12 lg:w-3/6 xl:w-1/2 2xl:w-1/2 flex flex-col">
                    <h1 className="text-slate-950 text-sm sm:text-sm md:text-base lg:text-base xl:text-xl 2xl:text-4xl pt-0 pb-3 sm:pt-3 sm:pb-1 md:pt-1 md:pb-2 lg:pt-5 xl:py-0 font-bold">
                        WEB DEVELOPMENT</h1>
                        <p 
                    ...
                    <h1 
                    className="text-slate-950 text-sm sm:text-sm md:text-base lg:text-base xl:text-xl 2xl:text-4xl pt-4 pb-3 sm:pb-0 sm:pt-0 sm:py-2 md:py-2 lg:py-3 xl:py-5 font-bold ">
